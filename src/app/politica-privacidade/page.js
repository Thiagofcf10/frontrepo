      ...
      <main className="flex-1 p-6">
        <div className="max-w-7xl mx-auto">
          <div className="bg-white rounded-lg shadow p-6">
            <h1 className="text-3xl text-gray-700 font-bold mb-4">Política de Privacidade</h1>
            ...
            <h2 className="text-xl text-gray-700 font-semibold mt-4">Dados coletados</h2>
            ...
            <h2 className="text-xl text-gray-700 font-semibold mt-4">Uso dos dados</h2>
            ...
            <h2 className="text-xl text-gray-700 font-semibold mt-4">Contato</h2>
